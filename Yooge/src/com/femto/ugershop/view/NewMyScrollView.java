 ...
 * ScrollView的滚动Y值进行监听
 */
public class NewMyScrollView extends ScrollView {
	...
	public NewMyScrollView(Context context, AttributeSet attrs, int defStyle) {
	...
	private Handler handler = new Handler() {
		...
		public void handleMessage(android.os.Message msg) {
			int scrollY = NewMyScrollView.this.getScrollY();
	...
	public NewMyScrollView(Context context, AttributeSet attrs) {
		super(context, attrs);
	}
