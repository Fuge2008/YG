...
public class Fragment_NewCustomOrder extends BaseFragment implements OnClickListener, OnRefreshListener2<ListView> {
	private View view;
	...
	private void getData(int status, int type, String starttime, String endtime, int pageIndex1, int pageSize) {
		...
		MyApplication.ahc.post(AppFinalUrl.usergetMakeProductList, params, new JsonHttpResponseHandler() {
			@Override
	...
	private void cancelorder(int orderId) {
		...
		params.put("id", orderId);
		params.put("token", MyApplication.token);
		MyApplication.ahc.post(AppFinalUrl.usercancleUserProductOrder, params, new JsonHttpResponseHandler() {
			@Override
			public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
				// TODO Auto-generated method stub
				super.onSuccess(statusCode, headers, response);
	...
	private void sureGet(int orderId) {
		...
		params.put("token", MyApplication.token);
		MyApplication.ahc.post(AppFinalUrl.usersureGetMakeProduct, params, new JsonHttpResponseHandler() {
			@Override
			public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
				// TODO Auto-generated method stub
				super.onSuccess(statusCode, headers, response);
