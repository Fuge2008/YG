...
public class Activity_MyCollectCustomGoods extends BaseActivity implements OnRefreshListener2<GridView>, OnItemClickListener {
	...
	public void setContentView() {
		...
		sWidth = (int) ((getWith() - dp2px(Activity_MyCollectCustomGoods.this, 30)) / 2.0);
	}
	...
	private void getData(int pi, int ps, String name) {
		...
		MyApplication.ahc.post(AppFinalUrl.usergetMyCollectionMakeProduct, params, new JsonHttpResponseHandler() {
			@Override
	...
	class MyAdapter extends BaseAdapter {
		...
		public View getView(int position, View v, ViewGroup parent) {
			...
			if (v == null) {
				h = new MyHolder();
				v = View.inflate(Activity_MyCollectCustomGoods.this, R.layout.item_nsc, null);
			...
			Glide.with(Activity_MyCollectCustomGoods.this).load(ms.get(position).smallUrl)
	...
	public void onPullUpToRefresh(PullToRefreshBase<GridView> refreshView) {
		// TODO Auto-generated method stub
		if (isend) {
			Toast.makeText(Activity_MyCollectCustomGoods.this, "没有更多", Toast.LENGTH_SHORT).show();
	...
	public void onItemClick(AdapterView<?> arg0, View arg1, int position, long arg3) {
		...
		Intent intent = new Intent(Activity_MyCollectCustomGoods.this, Activity_CustomGoodsDetails.class);
