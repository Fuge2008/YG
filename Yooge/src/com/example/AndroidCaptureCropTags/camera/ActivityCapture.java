package com.example.AndroidCaptureCropTags.camera;
...
import com.example.AndroidCaptureCropTags.util.Debug;
import com.example.AndroidCaptureCropTags.util.PathManager;
...
public class ActivityCapture extends Activity implements View.OnClickListener, CaptureSensorsObserver.RefocuseListener {
		...
		pictureCallBack = new PictureCallback() {
			...
			public void onPictureTaken(byte[] data, Camera camera) {
				...
				try {
					...
					// 此处就把图片压缩了
					options.inSampleSize = Math.max(options.outWidth / kPhotoMaxSaveSideLen, options.outHeight
	...
	private void openCamera() {
		...
		FrameLayout.LayoutParams params2 = new FrameLayout.LayoutParams(FrameLayout.LayoutParams.MATCH_PARENT,
