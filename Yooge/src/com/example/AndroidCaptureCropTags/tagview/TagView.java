...
public class TagView extends RelativeLayout implements View.OnClickListener {
	...
	private TagViewMoveListener movelistener;
	...
	public interface TagViewMoveListener {
	...
	public void setTagViewMoveListener(TagViewMoveListener movelistener) {
	...
	// System.out.println("zuo++++" + startx + "   " + starty);
	// taginfo.leftMargin = startx;
	// taginfo.topMargin = starty;
	// movelistener.onTagViewMove(this, taginfo);
	// break;
	//
	// }
	// return true;
