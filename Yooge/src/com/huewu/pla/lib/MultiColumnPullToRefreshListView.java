...
public class MultiColumnPullToRefreshListView extends MultiColumnListView {
	...
	private void init(Context context, AttributeSet attrs) {
		...
		if (attrs == null) {
			...
			// context,
			// attrs), android.view.ViewGroup.LayoutParams.MATCH_PARENT));
			lastUpdatedTextView.setTextSize(getDimensionDpSize(R.styleable.PullToRefreshView_ptrLastUpdateTextSize, context,
					attrs));
			image.setPadding(0, 0, (int) getDimensionDpSize(R.styleable.PullToRefreshView_ptrArrowMarginRight, context, attrs), 0);
		...
		flipAnimation = new RotateAnimation(0, -180, RotateAnimation.RELATIVE_TO_SELF, 0.5f, RotateAnimation.RELATIVE_TO_SELF,
				0.5f);
	...
	private void bounceBackHeader() {
		int yTranslate = state == State.REFRESHING ? header.getHeight() - headerContainer.getHeight() : -headerContainer
