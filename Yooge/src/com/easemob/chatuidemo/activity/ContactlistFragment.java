...
import com.easemob.chatuidemo.activity.ChatAllHistoryFragment.MyBCR;
import com.easemob.chatuidemo.widget.Sidebar;
import com.easemob.exceptions.EaseMobException;
import com.easemob.util.EMLog;
import com.femto.hx.adapter.ContactAdapter;
...
import com.femto.ugershop.easemob.applib.controller.HXSDKHelper.HXSyncListener;
...
public class ContactlistFragment extends Fragment {
	...
	private void getContactList() {
		...
		for (int i = 0; i < users.size(); i++) {
			System.out.println("zuogetContactList加载联系人" + users.size());
		}
