...
import com.femto.hx.video.util.ImageCache;
import com.femto.hx.video.util.ImageResizer;
import com.femto.hx.video.util.Utils;
import com.femto.ugershop.BuildConfig;
import com.femto.ugershop.R;
import com.femto.ugershop.easemob.applib.domain.VideoEntity;
...
public class ImageGridFragment extends Fragment implements OnItemClickListener {
	...
	public void onItemClick(AdapterView<?> parent, View v, final int position, long id) {
		...
		if (position == 0) {
			...
			// String st =
			// getResources().getString(R.string.temporary_does_not);
