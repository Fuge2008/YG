...
public class HXMainActivity extends EMBaseActivity implements EMEventListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.emactivity_main);
		initView();
		...
		public void onInvitationReceived(String groupId, String groupName,
			...
			runOnUiThread(new Runnable() {
				public void run() {
					...
					if (currentTabIndex == 0)
						chatHistoryFragment.refresh();
					if (CommonUtils.getTopActivity(HXMainActivity.this).equals(
			...
			runOnUiThread(new Runnable() {
				public void run() {
					try {
						...
						if (currentTabIndex == 0)
							chatHistoryFragment.refresh();
						if (CommonUtils.getTopActivity(HXMainActivity.this)
				...
				conflictBuilder.setPositiveButton(R.string.ok,
						new DialogInterface.OnClickListener() {
							...
							public void onClick(DialogInterface dialog,
								...
								conflictBuilder = null;
								finish();
								startActivity(new Intent(HXMainActivity.this,
										LoginActivity.class));
							}
						});
