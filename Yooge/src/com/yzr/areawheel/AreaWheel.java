...
public class AreaWheel {
	 ...
	 * 城市列表
	 */
	private final int[] ARRAY_CITY = new int[] { R.array.all_item, R.array.other_item, R.array.beijin_province_item,
			R.array.shanghai_province_item, R.array.hongkong_province_item, R.array.aomen_province_item,
			R.array.taiwan_province_item, R.array.tianjin_province_item, R.array.chongqing_province_item,
			R.array.heibei_province_item, R.array.shanxi1_province_item, R.array.neimenggu_province_item,
			R.array.liaoning_province_item, R.array.jilin_province_item, R.array.heilongjiang_province_item,
			...
			R.array.xizang_province_item, R.array.shanxi2_province_item, R.array.gansu_province_item,
			R.array.qinghai_province_item, R.array.ningxia_province_item, R.array.xinjiang_province_item };
	...
	public void initAreaPicker() {
		...
		wv_city.setAdapter(new ShiWheelAdapter(context, R.array.all_item));
		...
		OnWheelChangedListener wheelListener_provnce = new OnWheelChangedListener() {
			public void onChanged(WheelView wheel, int oldValue, int newValue) {
				wv_city.setShiAdapter(new ShiWheelAdapter(context, ARRAY_CITY[newValue]));
	...
	public String getArea() {
		...
		return wv_city.getAdapter().getItem(wv_city.getCurrentItem());
	}
